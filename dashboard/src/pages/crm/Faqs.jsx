    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      {loading ? (
        <div className="space-y-3">
          {[0, 1, 2].map((i) => (
            <div key={i} className="surface-glass rounded-md p-5 h-20 animate-pulse" />
          ))}
        </div>
        ...
        <div className="space-y-3">
          {filteredFaqs.map((faq) => (
            <div
              key={faq.id}
              className={`surface-glass rounded-md p-4 md:p-5 transition-colors space-y-3 ${
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="space-y-1.5 flex-1">
                  <div className="flex items-center space-x-2">
                    <span className="inline-flex items-center space-x-1 px-2 py-0.5 rounded text-[10px] font-semibold bg-teal-500/10 text-teal-400 border border-teal-500/20">
              ...
              {/* Respuesta */}
              <p className="text-xs md:text-sm text-slate-300 bg-slate-950/40 p-3.5 rounded border border-slate-700/40 leading-relaxed whitespace-pre-wrap">
                {faq.answer}
              </p>
            </div>
          ))}
